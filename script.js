...
function leaders(){
  ...
  for (var i = 0; i < leaderCount; i++){
      ...
      var marker = new google.maps.Marker({
            ...
            icon: 'https://cdn4.iconfinder.com/data/icons/people-groups-1/120/glyph_man_person-128.png',
      ...
      for(var i = 1; i < noOfUsers/5; i++){
          ...
          if (randNum%2==0){
              ...
              var marker = new google.maps.Marker({
                ...
                icon: 'https://www.irecarga.com.br/images/NewHomeImage/icon-casa.png',
